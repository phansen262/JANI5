...
@Entity
public class ERecordSO {

    //Contains: "exerciseName<@>workoutRecord<@>workoutIndex<@>logTime"
    ...
    public ERecordSO(@NonNull String recordKey, ExerciseSO exerciseSO, EVariantSO eVariantSO,
